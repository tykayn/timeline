...
<html>
    ...
    <body>
        ...
        $arr = array(
            '2000' => "tralalaaaa",
            '1987-09-16,'.date('Y-m-d') => "tykayn's life",
            '2007,2011' => "ESA Saint Luc Bruxelles",
            '2008-01-01,NOW' => "Expérience en développement web",
            'NOW' => "là",
//            '1987-01-02,2013-01-01' => "tralalaaaa",
//            '2006' => "tralalaaaa",
//            '2006' => "trololo",

//            '2002-01-02' => "tralalaaaa",
//            '2002' => "tralalaaaa",
//            '2008-02-01,2010-02-01' => "tralalaaaa",
            '1980-01-01,1989-12-31' => "années 80",
            '1990-01-01,1999-12-31' => "années 90",
            '2000-01-01,2009-12-31' => "années 2000",
            '2010-01-01,2019-12-31' => "années 2010",
        );
        $tl->setBonusWidth(0);
        ?>
        <div class="top">
            <img src="icon.png" alt="icone"/>
            <a href="http://artlemoine.com"><img alt="favicon " src="http://artlemoine.com/favicon.png"/> Portfolio de Baptiste Lemoine</a>
...
<?php echo 'Le jour de ma naissance était un ' . $tl->datejour('1987-09-16'); ?>.<br/>
                    ...
                    <?php
                    echo 'Ce portfolio a été créé le 15/08/2009, c\'est à dire ' .
                    $tl->ecart('2009-08-15') .
