...
<a href="random_picture.txt">Télécharger Random_picture.txt</a>.<br/>
Renommez le .txt en .php et mettez le dans le dossier hébergé avec les images que vous voulez afficher au hasard.
<br/>
Pour pouvoir utiliser la fonction d'image aléatoire il faut l'inclure en php.<br/>
<code>< ?php <br/>
...
Si vous n'avez pas d'image dans le dossier où cherche le script il vous écrira ceci:
<strong>(pas d'image dans ce dossier)</strong>
<h2>Style des images aléatoires</h2>
chaque image est retournée avec une classe "<i>random_picture</i>" que vous pouvez personnaliser en css.
